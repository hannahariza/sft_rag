...
IMAGE_PATH = "/root/lanyun-tmp/data_download/mrag/data_new/pdfvqa/"
...
if __name__ == '__main__':
    ...
    for i, item in enumerate(dataset):
        ...
        try:
            # 调用answer_with_mrag生成答案
            generated_answer, results, results_rank = answer_with_mrag(
                text_query=question,
                retrieval_top_k=3,
                reranker_top_k=1,
                max_new_tokens=500,
            ...
            # 保存结果
            answer_item = {
                "image": item.get('image', f'image_{i}.png'),
                "question": question,
    ...
    logger.info(f"答案生成完成，共生成 {len(answers)} 条答案")
